...
The junta project has strict rules for AI usage:
...
These rules apply only to outside contributions to junta. Maintainers
...
Please remember that junta is maintained by humans.
...
junta is written with plenty of AI assistance, and many maintainers embrace
